		...
		<div class="container-fluid">
      		<div class="row">
      			...
      			<div class="col-lg-3">
      				...
      				<a href=""><img src="logos_sm/instagram.png" alt="phoneicon" class="navbar-brand" style="width: 44px;"></a>
      				<a href=""><img src="logos_sm/youtube.png" alt="phoneicon" class="navbar-brand" style="width: 44px;"></a>
      			</div>	
      		</div>
      	</div>
